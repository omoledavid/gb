    ...
    <div class="col-xl-3 col-lg-5 col-md-5 col-sm mb-30">
        ...
        <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
            <div class="card-body">
                ...
                <a href="{{route('admin.users.email.single',$user->id)}}" class="btn btn--info btn--shadow btn-block btn-lg">
                    @lang('Send Email')
                </a>
            ...
            <form action="{{route('admin.users.add.sub.balance', $user->id)}}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            <label>Details/Reason for transfer<span class="text-danger">*</span></label>
                            <div class="input-group has_append">
                                <input type="text" name="details" class="form-control" placeholder="@lang('Provide reason for transfer')">
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <label>Enter transaction date<span class="text-danger">*</span></label>
                            <div class="input-group has_append">
                                <input type="datetime-local" name="date" class="form-control" placeholder="@lang('Please provide positive amount')">
                            </div>
                        </div>
                    </div>
                </div>
